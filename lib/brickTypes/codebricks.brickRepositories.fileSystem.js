	...
	function save(options, callback) {
		fs.exists(self.path, function(exists) {
			if (!exists) {
				...
				env.methods.BrickTypeDefinition.serializeBricks({ brick : options.brick, deep : options.deep }, function(err, brickJsonArray) {
	...
	function get(options, callback) {
		fs.exists(self.path, function(exists) {
			if (!exists) {
				...
				env.methods.BrickTypeDefinition.deserializeBricks({ id : options.id, deep : options.deep }, function(brickOptions, nextBrick) {
