		...
		if (self.path === undefined) { callback(null, false); } else {
			...
			if (match == null) { callback(null, false); } else {
				if (self.content === undefined) {
					...
					console.log(self.content.__.context.owner);
					console.log("The context should be undefined because this brick should have been refreshed!!");
					console.log(self.content.__.context.get("request"));
