module.exports = {
	...
	BrickPropertyType : BrickPropertyType
};

module.exports.BrickPropertyTypeDefinition.name = "BrickPropertyTypeDefinition";

/* BrickPropertyTypeDefinition */
function BrickPropertyTypeDefinition(name, id, constructor) {
	var self = this;
	self.name = name;
	self.id = id;
...
/* BrickPropertyType */
function BrickPropertyType(definition, constructor) {
	var self = this;
