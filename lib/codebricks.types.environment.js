	...
	function start(definitionSources, callback) {
		...
		definitionsLoader.load(definitionSources, function(err, definitions) {
			if (err) { callback(err); } else {
				...
				self.methods = {};
				self.definitions.DefinitionTypes.forEach(function(definitionType) {
					self.methods[definitionType.definition.name] = new definitionType.definition.methods(self);
				});
